...
simdata_vi <- read.csv("./data/sup_sarsa_variable_interval.csv")
simdata_vr <- read.csv("./data/sup_sarsa_variable_ratio.csv")
simdata_choice <- read.csv("./data/sup_sarsa_choice.csv")
simdata_noncontigent <- read.csv("./data/sup_sarsa_noncontingent.csv")
...
ggsave("./hbtfmt/figs/supfig-05-a.jpg", dpi = 300, width = 10.0, height = 10.0)
...
ggsave("./hbtfmt/figs/supfig-05-b.jpg", dpi = 300, width = 10.0, height = 10.0)

# supplementary fig 4(c)
ggplot() +
...
ggsave("./hbtfmt/figs/supfig-05-c.jpg", dpi = 300, width = 10.0, height = 10.0)

# supplementary fig 4(d)
ggplot() +
...
ggsave("./hbtfmt/figs/supfig-05-d.jpg", dpi = 300, width = 10.0, height = 10.0)
